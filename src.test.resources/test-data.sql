...
INSERT INTO topics (id, date_created, text, token, category_id) VALUES (1, { ts '2016-01-26 00:00:00.00'}, 'I like pink!', '1475eace-926a-45ee-b954-e72bfbb98ae3', 1);
INSERT INTO topics (id, date_created, text, token, category_id) VALUES (2, { ts '2016-07-31 00:00:00.00'}, 'I like chinese food.', '8df15654-21f2-42ae-85f0-d7802c8a6d4c', 2);
INSERT INTO topics (id, date_created, text, token, category_id) VALUES (3, { ts '2016-05-16 00:00:00.00'}, 'I like tattoos.', 'a2873348-029b-4a84-86f5-932aa5f80331', 3);
